...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'about.image', 'value' => '', 'group' => 'about', 'is_public' => true],
            ['key' => 'store.latitude', 'value' => '', 'group' => 'store', 'is_public' => true],
            ['key' => 'store.longitude', 'value' => '', 'group' => 'store', 'is_public' => true],
            ['key' => 'store.google_maps_url', 'value' => '', 'group' => 'store', 'is_public' => true],
            ['key' => 'store.google_maps_embed_url', 'value' => '', 'group' => 'store', 'is_public' => true],
            ['key' => 'store.business_hours', 'value' => '', 'group' => 'store', 'is_public' => true],
